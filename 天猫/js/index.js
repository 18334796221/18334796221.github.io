...
//右边固定栏
{
    var items=document.querySelectorAll(".mulu-inner li.item");
    var tips=document.querySelectorAll(".mulu-inner li .tip");

    items.forEach(function (ele,index) {
        ele.onmouseover=function () {
            tips[index].style.display="block";
            animate(tips[index],{left:-100,opacity:1});
        };
        ele.onmouseout=function () {
            animate(tips[index],{left:-180,opacity:0.5},function () {
